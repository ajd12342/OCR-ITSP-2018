function [prediction confidence]= predict_combined(Theta1, Theta2, Theta3, parentimg, no_char_combined)
pkg load image;
 ...
 % parentimg=1-parentimg;
  ...
  for j=1:no_char_combined
    ...
    for t=1:i-1
      ...
      dp_answers(j,i)=strcat(dp_answers(j-1,t),char(96+value));
      endif
    endfor
  endif
endfor
...
confidence=dp_products(no_char_combined,xsize);
%hold on;
%tcut
